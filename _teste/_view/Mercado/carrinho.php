...
<table>
    ...
    <tfoot>
           <tr>
            ...
            <tr>
            <td colspan="5"><a href="melhorias.php">Continuar Comprando</a></td>
            <tr>
            <td colspan="5"><a href="../../../_view/viewEstadio.php">Voltar</a></td>
            <tr>
            <td colspan="5"><input type="button" value="Finalizar Compras" class="botao"  
                              onclick="JavaScript:location.href='confirmarCompra.html';" /></td>
